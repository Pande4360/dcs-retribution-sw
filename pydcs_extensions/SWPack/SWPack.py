...
@vehiclemod
class ReTrooper(unittype.VehicleType):
    id = "ReTrooper"
    name = "Rebel Trooper"
    detection_range = 0
    threat_range = 1500
...
@vehiclemod
class StTrooper(unittype.VehicleType):
    id = "StTrooper"
    name = "Storm Trooper"
    detection_range = 0
    threat_range = 1500
...
@shipmod
class CalamariCruiser(unittype.ShipType):
    id = "CalamariCruiser"
    name = "SW - Calamari Cruiser"
    plane_num = 72
    helicopter_num = 6
    parking = 11
    detection_range = 60000
    threat_range = 0
    air_weapon_dist = 60000
...
class Laat(HelicopterType):
    ...
    livery_name = "LAAT"  # from type

    pylons: Set[int] = set()

    tasks = [task.Transport, task.CAS, task.Reconnaissance]
